...
<body>
	...
	<fieldset>
		...
		<table width="35%">
			...
			<tr>
                <td><br><input type="submit" name="login" value="登入"  style="width: 100%;" class="login_btn"/></td>
		</form>
		<form action="redgister.php" method="POST">
				<td><br>&emsp;&emsp;&emsp;<input type="submit" name="login" value="註冊"  style="width: 35%;" class="login_btn"/></td>
            </tr>
		</form>
		</table>
	</fieldset>
